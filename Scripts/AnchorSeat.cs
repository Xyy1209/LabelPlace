...
public class AnchorSeat : MonoBehaviour, IManipulationHandler, IFocusable
{
    ...
    {
        this.gameObject.GetComponentInChildren<TextMesh>().fontSize = 39;
    ...
    public void OnFocusExit()
    {
        ...
        this.gameObject.GetComponentInChildren<TextMesh>().fontSize = 35;

...
public class AnchorWheel : MonoBehaviour, IManipulationHandler, IFocusable
{
    ...
    {
        this.gameObject.GetComponentInChildren<TextMesh>().fontSize = 50;
    ...
    public void OnFocusExit()
    {
        ...
        this.gameObject.GetComponentInChildren<TextMesh>().fontSize = 42;
